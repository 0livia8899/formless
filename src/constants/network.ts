...
const NETWORK_CONFIG_LIST: Record<string, TNetworkConfig> = {
  mainnet: {
    ...
    webLoginGraphqlUrl: 'https://dapp-aa-portkey.portkey.finance/aefinder-v2/api/app/graphql/portkey',
  ...
  testnet: {
    ...
    webLoginGraphqlUrl: 'https://dapp-aa-portkey-test.portkey.finance/aefinder-v2/api/app/graphql/portkey',
    ...
    contractAddress: BACCART_CONTRACT_ADDRESS || 'QTB6vx1ju35Meiu6K6AnCvdaCjDt4p5ihVNuweTwJFbfaNNat',
